...
pub extern fn GuiSetStyle(control: GuiControl, property: GuiControlProperty, value: c_int) void;
pub extern fn GuiGetStyle(control: GuiControl, property: GuiControlProperty) c_int;
